...
<head>
    ...
    <link rel="icon" type="image/png" sizes="16x16" href="plugins/images/block.png">
    <title>Agri-Food Supply Chain Traceability System Based on RFID and Block Chain Technology</title>
    <!-- Bootstrap Core CSS -->
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top m-b-0 sidebar">
            <div class="navbar-header"> 
                <div class="top-left-part"><a class="logo" href="index.php"><b><img  src="plugins/images/rsz_block1.png" alt="home" /></b><span class="hidden-xs">Supply Chain</span></a></div>
            </div>
        </nav>
        <!-- Left navbar-header -->
